...
export const BUCKET_ROWS: readonly BucketRow[] = [
  ...
  { key: 'people', label: 'People', note: 'Bonos y reparto, solo con ganancia', color: '#42a5f5' },
  { key: 'infra_buffer', label: 'Reserva de infra', note: 'Growth frenado por salud del server', color: 'var(--chart-5)' },
  { key: 'unallocated', label: 'Sin asignar', note: 'Queda en la caja, lo decidís vos', color: '#bbdefb' },
]
